...
#ifndef PART_DIRECT_ORIGINAL_PSENDREQ_H
#define PART_DIRECT_ORIGINAL_PSENDREQ_H
...
struct mca_part_direct_original_psend_request_t {
    mca_part_direct_original_request_t req_base;
};
typedef struct mca_part_direct_original_psend_request_t mca_part_direct_original_psend_request_t;
OBJ_CLASS_DECLARATION(mca_part_direct_original_psend_request_t);


#define MCA_PART_DIRECT_ORIGINAL_PSEND_REQUEST_ALLOC(sendreq, comm, dst,          \
                                           ompi_proc)                 \
do {                                                                  \
    sendreq = (mca_part_direct_original_psend_request_t*)                         \
        opal_free_list_wait (&mca_part_direct_original_psend_requests);          \
    sendreq->req_base.req_type = MCA_PART_DIRECT_ORIGINAL_REQUEST_PSEND;          \
} while(0)

#define MCA_PART_DIRECT_ORIGINAL_PSEND_REQUEST_INIT( req_send,                    \
                                         ompi_proc,                   \
                                         comm,                        \
                                         tag,                         \
                                         dst,                         \
 ...
 */
#define MCA_PART_DIRECT_ORIGINAL_PSEND_REQUEST_RETURN(sendreq)                      \
    {                                                                   \
        ...
        opal_free_list_return ( &mca_part_direct_original_psend_requests,            \
