...
#ifndef PART_DIRECT_ORIGINAL_REQUEST_H
#define PART_DIRECT_ORIGINAL_REQUEST_H
 ...
 */
typedef enum {
    MCA_PART_DIRECT_ORIGINAL_REQUEST_PSEND,
    MCA_PART_DIRECT_ORIGINAL_REQUEST_PRECV,
    MCA_PART_DIRECT_ORIGINAL_REQUEST_NULL
} mca_part_persist_request_type_t;

struct mca_part_direct_original_list_t;
 ...
 */
OMPI_DECLSPEC extern opal_free_list_t mca_part_direct_original_psend_requests;
OMPI_DECLSPEC extern opal_free_list_t mca_part_direct_original_precv_requests;

/**
 *  Base type for PART DIRECT requests
 */
struct mca_part_direct_original_request_t {

/* START: These fields have to match the definition of the mca_part_direct_original_request_t */
...
/* END: These fields have to match the definition of the mca_part_direct_original_request_t */
    ...
    struct mca_part_direct_original_list_t* progress_elem; /**< pointer to progress list element for removal durring free. */ 

};
typedef struct mca_part_direct_original_request_t mca_part_direct_original_request_t;
OBJ_CLASS_DECLARATION(mca_part_direct_original_request_t);
