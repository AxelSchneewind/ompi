...
#ifndef PART_DIRECT_AGGREGATED_REQUEST_H
#define PART_DIRECT_AGGREGATED_REQUEST_H
 ...
 */
typedef enum {
    MCA_PART_DIRECT_AGGREGATED_REQUEST_PSEND,
    MCA_PART_DIRECT_AGGREGATED_REQUEST_PRECV,
    MCA_PART_DIRECT_AGGREGATED_REQUEST_NULL
} mca_part_persist_request_type_t;

struct mca_part_direct_aggregated_list_t;

struct ompi_mca_direct_aggregated_setup_t {
   int world_rank;
   int start_tag;
   int setup_tag;
   size_t num_parts;
 ...
 */
OMPI_DECLSPEC extern opal_free_list_t mca_part_direct_aggregated_psend_requests;
OMPI_DECLSPEC extern opal_free_list_t mca_part_direct_aggregated_precv_requests;

/**
 *  Base type for PART DIRECT_AGGREGATED requests
 */
struct mca_part_direct_aggregated_request_t {

/* START: These fields have to match the definition of the mca_part_direct_aggregated_request_t */
...
/* END: These fields have to match the definition of the mca_part_direct_aggregated_request_t */
    ...
    opal_atomic_size_t mark_count; /**< counter for the number of partitions marked ready */

    int32_t *flags;               /**< array of flags to determine whether a partition has arrived */

    struct mca_part_direct_aggregated_list_t* progress_elem; /**< pointer to progress list element for removal durring free. */ 

};
typedef struct mca_part_direct_aggregated_request_t mca_part_direct_aggregated_request_t;
OBJ_CLASS_DECLARATION(mca_part_direct_aggregated_request_t);
