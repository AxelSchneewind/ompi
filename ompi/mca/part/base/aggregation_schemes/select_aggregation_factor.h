 ...
 * @param (IN)  count                size of user-provided partitions in bytes
 * @param (IN)  max_parts            maximal number of internal partitions
 * @param (IN)  min_count            minimal size of internal partitions in bytes
