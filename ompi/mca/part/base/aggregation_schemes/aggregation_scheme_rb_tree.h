...
int interval_comp(interval_state_t*, interval_state_t*);
 ...
 */
OMPI_DECLSPEC void aggregation_scheme_rb_tree_init(struct part_persist_rb_tree_aggregation_state_t *state, int parts, int factor);
