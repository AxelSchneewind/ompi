...
struct ompi_mca_persist_aggregated_setup_t {
   int world_rank;
   int start_tag;
   int setup_tag;
   size_t num_parts;
 ...
 */
OMPI_DECLSPEC extern opal_free_list_t mca_part_persist_aggregated_psend_requests;
OMPI_DECLSPEC extern opal_free_list_t mca_part_persist_aggregated_precv_requests;


/**
 *  Base type for PART persist_aggregated requests
 */
...
/* START: These fields have to match the definition of the mca_part_persist_aggregated_request_t */
    ...
    mca_part_persist_aggregated_request_type_t req_type; /**< MPI request type - used for test */
